/**
 * TEMPORARY prefilled BACKFILL paste for KC today (v1.3.0 rules).
 * Logic matches: built-by-shah-mcc-standalone-backfill-negatives-sweeper-final-v1.1.0.js
 * After catch-up: delete this Scripts row. Schedule the DAILY final instead:
 *   built-by-shah-mcc-standalone-daily-negatives-sweeper-final-v1.1.0.js
 *
 * Prefills: 4 Account IDs + emails (incl. ciprian@). IGNORE_DONE_LABEL: true.
 */

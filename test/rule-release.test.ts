...
test("release gate rejects bulk phrase protections, stable edits, and multi-section policy changes", async (t) => {
  ...
  await writeFile(rulePath, originalRules.replace("2026-09-09.1", "2026-09-09.2").replace("KEEP generic collision", "KEEP all generic collision").replace("KEEP genuine generic automotive", "KEEP all genuine generic automotive"));
  await release();

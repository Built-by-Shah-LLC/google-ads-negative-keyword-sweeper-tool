...
function addOrganizationSheet(
  ...
  const infoRows: Array<[string, string | number | null]> = [
    ...
    ["Google Ads mutation mode", summary.mutation.mode],
    ["Google Ads mutation status", summary.mutation.status],
    ["Google Ads mutation performed", summary.mutation.googleAdsMutationPerformed ? "Yes" : "No"],
    ["Mocked negative writes", summary.mutation.mockedCount],
    ["Validated negative writes", summary.mutation.validatedCount],
    ["Applied and verified negatives", summary.mutation.verifiedCount],
    ["Failed negative writes", summary.mutation.failedCount],
    ["Unknown mutation outcomes", summary.mutation.unknownCount],

# CAPITAL COLLISION — LLM fixed prompt context

- Google Ads customer ID: `1130534333`
- Generated at: `2026-09-24T18:02:24.674Z`
- Policy: `capital-collision` revision `2026-09-23.1`
- Base rule version: `2026-09-16.1`
- Dynamic rules: 4
- Account phrase protections: 3
- Positive keywords: 320
...
## Account-specific rules (policy: capital-collision, revision: 2026-09-23.1)
...
### `POL-CAPITAL-OWN-BRANDS-KEEP` — Capital Collision approved brand names

KEEP service-seeking queries for Capital Collision and its approved location brands: Capital Collision, Riverside Collision Center, and Woodcrest Collision Center. These are this account's own brands, not competitors. Independent negative evidence such as careers, DIY, towing-only, price-shopping, or reviews still applies.
